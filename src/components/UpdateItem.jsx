    ...
    return (
        <div>
            ...
            <div>
                ...
                <input type="text" name="name" placeholder="Enter Door name..." onChange={handleInput} value={doorForm.name} />
                <input type="text" name="status" placeholder="Enter status..." onChange={handleInput} value={doorForm.status} />
                <input type="submit"/>
                </form>
            </div>
        </div>
